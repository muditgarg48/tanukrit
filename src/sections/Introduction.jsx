...
const Introduction = () => {
    ...
    return (
        <section id="about" data-nav-theme="light" className="min-h-screen flex flex-col bg-white px-4 pb-24 overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto w-full">
                    <div className="flex flex-col md:flex-row items-center gap-16">
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed max-w-xl mx-auto md:mx-0">
                                {description}
                            </p>
